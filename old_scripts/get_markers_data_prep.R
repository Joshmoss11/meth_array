...
all.10 <- all.10[,!colnames(all.10) %in% c("Mix","Negative","cfDNA","Cord_blood","Leukocytes_cord_blood")]
all.90 <- all.90[,!colnames(all.90) %in% c("Mix","Negative","cfDNA","Cord_blood","Leukocytes_cord_blood")]
